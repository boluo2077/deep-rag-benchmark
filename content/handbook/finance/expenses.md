...
- If you have any questions regarding a rejected expense due to being out of policy, submit a request under the `Expenses -> General Expenses` tile  [HelpLab](/handbook/business-technology/enterprise-applications/guides/helplab-guide/), ensuring that you tag your Manager , and adding any other additional documentation so this can be reviewed.
...
- Business cards are ordered from Moo as per the instructions provided by the People Operations team.
...
- The space should be located within a commutable distance (+-50km) of the Team Member's primary residence in their country of employment, with exception to One-off days (day passes) if the Team Member is traveling for business. This is for tax reasons.
- Co-working spaces must be professionally managed facilities whose primary business purpose is providing shared workspace services. Leasing of apartments, private properties, or facilities where co-working is offered as a secondary or ancillary service (such as gyms, country clubs, golf clubs, hotels, cafes, or recreational venues) is prohibited. Only dedicated co-working providers whose core business model centers on workspace rental are acceptable.
...
- **Expense Type / Navan Policy Category:** Co-working Space
...
- Existing Team Members will get a yearly refresh of 500 USD (or equivalent local currency) to purchase upgrades, replacements, or enhancements to your home office setup. This only applies to Team Members who have been employed the entire previous calendar year. This excludes laptops - please connect with the IT team if you require a replacement laptop.
...
- Any items outside this will fall under an exception to the policy and will require approval prior to purchase via the HelpLab process - `Expenses -> Home Office Equipment` page of [HelpLab](/handbook/business-technology/enterprise-applications/guides/helplab-guide/).
- In addition the following items are not reimbursable: Phones, watches, smart speakers, smart TVs/smart monitors, walking pads/treadmills,tablets, book shelves, shelves, Cabinets, other furniture, wifi Mesh, Routers, Extenders/Boosters.
...
- Any unused funds will not roll over to the next year.
- Team Members hired within the previous calendar year are not eligible. For example, a Team Member who started 2023-05-10 will get their first refresh amount on 2025-01-01.

![Approved WFH Equipment List](/images/finance/expenses/approved-wfh-equipment-list.png)

## Approved WFH Equipment List
...
- Mouse
- Webcam
- Monitor(s) and monitor stands
- External microphone
- Headphones or headset
- Docking station or USB hubs
- Cables and Adapters
- Privacy Screen
- Replacement for Laptop battery
- Replacement for Laptop charger
...
- Printer, scanner, or all-in-one device
- Shredder
- Laptop bag/case
- Mouse Pad
- Wrist rest
...
- To maintain your home office equipment, certain items may be required from time to time. Please see list below for acceptable office supplies and consumables.
- Limit is set at $50.00 per month.
![Approved Office Supplies List](/images/finance/expenses/approved-office-supplies-list.png)

## Approved Office Supplies List
...
- Team members to please use T&E accounts for their own individual expenses relating to any team building events (ie meals, travel, transportation) and tagging the classification to "FY26 Team Building Budget"
...
- In Navan, the Team Member must code any related expense to GL code "Team events & meals" and Classification (under optional details) "FY26 Team Building Budget".
...
- Expenses for GitLab Inc, GitLab Federal, GitLab Ltd (UK), GitLab BV (Belgium and Netherlands), GitLab GmbH (Germany), GitLab PTY Ltd (Australia and New Zealand), GitLab GK (Japan) GitLab LTD (Ireland), GitLab Israel Ltd., GitLab Korea Limited, GitLab Canada Corp and GitLab Singapore PTE. LTD. are reimbursed via Navan within 7 business days for the expenses within policy or after approval by the Accounts Payable team (for out of policy expenses).
...
- The list of locations under a PEO can be found [here](/handbook/people-group/employment-solutions/#peo-professional-employer-organization-employer-of-record-and-not-a-gitlab-entity-or-branch).
- Team Members must submit their expenses through Navan.
...
- Please refer to the [Navan End Users Guide](/handbook/business-technology/enterprise-applications/guides/navan-expense-guide/) for instructions on how to use the Navan Expense Tool. Any related questions can be directed to the team via HelpLab. 
